    ...
    def do_POST(self):
        ...
        try:
            ...
            if self.path == '/addCourse':
                ...
                course_name = form.getvalue("coursename")
            ...
            if self.path == '/searchStudent':
                ...
                self.database.showCourses(student_id)
                self.wfile.write(b"<html><head><title> Teacher's Portal </title></head>")
                self.wfile.write(b"<body>")
                self.wfile.write(b"<center><h1>Teacher's Portal</h1>")
                self.wfile.write(b"<hr>")
                ...
                self.wfile.write(b"</center></body></html>")
                data=[]
                records = self.database.showCourses(student_id)
                for record in records:
                    data=record.fetchall()
                self.send_response(200)
                self.wfile.write(b"<center><hr><h2>Inforamtion of the Student</h2>")
    ...
    def do_GET(self):
        try:
            ...
            if self.path == '/searchStudent':
                ...
                self.wfile.write(b"<label for='studentit'>Student ID:</label>\
